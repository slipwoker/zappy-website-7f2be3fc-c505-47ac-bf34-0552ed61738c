document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') && !VALIDATORS.required(value)) {
        ...
        field.hasAttribute('data-minlength') &&
        value.trim() !== '' &&
        !VALIDATORS.minlength(value, field.getAttribute('data-minlength'))
      ) {
  ...
  function initScrollAnimations() {
    const animatableEls = document.querySelectorAll('.' + OBSERVE_CLASS);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "גופנה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7f2be3fc-c505-47ac-bf34-0552ed61738c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7f2be3fc-c505-47ac-bf34-0552ed61738c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7f2be3fc-c505-47ac-bf34-0552ed61738c';
